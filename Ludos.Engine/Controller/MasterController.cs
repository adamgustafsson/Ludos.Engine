...
using Ludos.Engine.Utillities.Debug;
...
namespace Ludos.Engine.Controller
{
    class MasterController : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _debugInfo.DrawRectancgle(_spriteBatch, (int)_player.Bounds.Width, (int)_player.Bounds.Height, _camera.VisualizeCordinates(_player.Bounds), transparancy: 0.50f);
